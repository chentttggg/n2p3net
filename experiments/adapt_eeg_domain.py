...
from data.domain import adapt_common_channel_average_reference  # noqa: E402
...
def main() -> None:
    ...
    adapted = adapt_common_channel_average_reference(dataset, channels, name=args.name)
